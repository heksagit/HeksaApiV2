...
namespace HeksaApiV2.Model.Common
{
    public class DataTableResult<T>
    {
        ...
        [JsonProperty("otherResult", NullValueHandling = NullValueHandling.Ignore)]
        public dynamic OtherResult { get; set; }
    }
    ...
    public class DtParameters
    {
        ...
        {
            Search = new DtSearch();
            CustomSearch = new DtCustomSearch();
        }
        /// <summary>
        /// Draw counter.
        ...
        public DtCustomSearch CustomSearch { get; set; }
